    ...
    export default {
        ...
        methods: {
            async redirect() {
                ...
                window.location.href='https://accounts.spotify.com/authorize?response_type=code&client_id=280ec2cdd2bd49549c49ee81a7017af3&redirect_uri=https%3A%2F%2Fastrolify.netlify.app&scope=user-read-private%20user-read-email%20user-top-read%20playlist-read-private'
            },
